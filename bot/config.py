...
try:
    APP_ID = config("APP_ID", "4926633", cast=int)
    API_HASH = config("API_HASH", "be7b1d39ac5116d22701f8b6ac956785")
    BOT_TOKEN = config("BOT_TOKEN", "5202925982:AAGn_FROGTtB9hdsjtzA6IHNC4uDMigHpOw")
    DEV = 1359955110
    OWNER = config("OWNER", "1359955110")
